...
##############################################################################   shell调整环境   ########################################################################################
############################################################################################################################################################################################
#环境切换前的语句不会再次执行，且变量清空。因此shell环境切换需前置。切换后，if语句内的其他代码也不会被执行。在bash中$0为脚本自身路径。但在zsh中$ZSH_ARGZERO为脚本路径
...
##############################################################################   不同系统配置及变量   ########################################################################################
############################################################################################################################################################################################
#在bash中可能$SHELL为脚本自身环境。但在zsh中可能$(ps -p $$ -o comm=)为脚本自身环境
